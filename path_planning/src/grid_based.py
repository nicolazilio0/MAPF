...
def build_8dir_adjacency_matrix(map_matrix):
    rows, cols = map_matrix.shape
    adjacency_matrix = np.zeros((rows * cols, rows * cols), dtype=int)
                    ...
                    if is_valid(ni, nj):
                        ...
                        if map_matrix[i, j] == 1 or map_matrix[ni, nj] == 1:
                            ...
                            if(di**2 == 1 and dj**2 == 1): 
                                adjacency_matrix[current_node, neighbor_node] = 5
...
if __name__ == '__main__':
    ...
    if(goal_1[1]//cell_size==grid_size and goal_1[0]//cell_size==grid_size):
        occupancy_matrix[int(goal_1[1]//cell_size)-1,int(goal_1[0]//cell_size)-1,2]=2
        goal_1=int(goal_1[0]//cell_size)-1+int((goal_1[1]//cell_size)-1)*grid_size


    elif goal_1[1]//cell_size==grid_size:
        occupancy_matrix[int(goal_1[1]//cell_size)-1,int(goal_1[0]//cell_size),2]=2
        goal_1=int(goal_1[0]//cell_size) +int((goal_1[1]//cell_size)-1)*grid_size

    elif goal_1[0]//cell_size==grid_size:
        occupancy_matrix[int(goal_1[1]//cell_size),int(goal_1[0]//cell_size)-1,2]=2
        goal_1=int(goal_1[0]//cell_size)-1+(int(goal_1[1]//cell_size))*grid_size
    ...
    if(goal_2[1]//cell_size==grid_size and goal_2[0]//cell_size==grid_size):
        occupancy_matrix[int(goal_2[1]//cell_size)-1,int(goal_2[0]//cell_size)-1,2]=2
        goal_3=int(goal_2[0]//cell_size)-1+int((goal_2[1]//cell_size)-1)*grid_size

    elif(goal_2[1]//cell_size==grid_size):
        occupancy_matrix[int(goal_2[1]//cell_size)-1,int(goal_2[0]//cell_size),2]=2
        goal_2=int(goal_2[0]//cell_size)+int((goal_2[1]//cell_size)-1)*grid_size

    elif(goal_2[0]//cell_size==grid_size):
        occupancy_matrix[int(goal_2[1]//cell_size),int(goal_2[0]//cell_size)-1,2]=2
        goal_2=int(goal_2[0]//cell_size)-1+int((goal_2[1]//cell_size))*grid_size
    ...
    if(goal_3[1]//cell_size==grid_size and goal_3[0]//cell_size==grid_size):
        occupancy_matrix[int(goal_3[1]//cell_size)-1,int(goal_3[0]//cell_size)-1,2]=2
        goal_3=int(goal_3[0]//cell_size)-1+int((goal_3[1]//cell_size)-1)*grid_size

    elif(goal_3[1]//cell_size==grid_size):
        occupancy_matrix[int(goal_3[1]//cell_size)-1,int(goal_3[0]//cell_size),2]=2
        goal_3=int(goal_3[0]//cell_size)+int((goal_3[1]//cell_size)-1)*grid_size
    
    elif(goal_3[0]//cell_size==grid_size):
        occupancy_matrix[int(goal_3[1]//cell_size),int(goal_3[0]//cell_size)-1,2]=2
        goal_3=int(goal_3[0]//cell_size)-1+int((goal_3[1]//cell_size))*grid_size
    ...
    adjacency_matrix = build_8dir_adjacency_matrix(occupancy_matrix[:,:,2])
    ...
    if(best_paths[0] is None or best_paths[1] is None or best_paths[2] is None):
        print("one of the robots cannot reach the goal")
        exit()
    ...
    best_paths=check_conflicts(best_paths[0],best_paths[1],best_paths[2])
